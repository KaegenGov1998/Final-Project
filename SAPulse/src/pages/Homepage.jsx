  ...
  return (
    <div className="flex flex-row bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col">
        <div className="pt-8 pl-12 text-2xl font-bold text-gray-500">What's Happening in <span className="text-blue-900">{area}?</span></div>
        ...
        <div className="flex flex-row flex-wrap px-8 py-8 overflow-y-auto">
          {posts.map((post) => (
            <div
              key={post.id}
              className="flex flex-col justify-between w-50 h-60 p-4 m-4 border-2 border-gray-200 rounded-md shadow-sm overflow-auto"
            >
